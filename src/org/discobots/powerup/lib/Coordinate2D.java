...
public class Coordinate2D {
	...
	private double yMin = -324;
	private double yMax = 324;
	
	private double startingLine = 120;
	
	private double nullZone_yStart = -36;
	private double nullZone_yEnd   = 36; 
	...
	private double portal_y      = 289;
	
	private double exchange_xStart = 12;
	private double exchange_xEnd   = 60;
	private double exchange_y      = 288;
